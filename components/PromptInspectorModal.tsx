    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink/60 p-4 backdrop-blur-xs">
      <div className="flex h-[88vh] w-full max-w-4xl flex-col rounded-lg border border-line bg-surface shadow-2xl">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-sm font-bold text-ink">
                AI Prompts & Processing Stages
              </h3>
              <p className="text-[11px] text-muted">
                Read-only view of the AI instructions used in this clinical workflow
              </p>
            </div>
          </div>
          <button
        ...
        <div className="flex-1 overflow-y-auto p-6 text-xs">
          {loading ? (
            <div className="flex h-64 flex-col items-center justify-center gap-2 text-muted">
              ...
              <span>Fetching AI prompts and processing stages...</span>
            </div>
          ) : !data ? (
            ...
            <>
                <div className="space-y-5">
                  ...
                  <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <p className="mt-1 text-[11px] font-medium text-slate-600">Used during Stage 1 to convert the uploaded or recorded audio into a verbatim transcript.</p>
                  </div>
                  ...
                  <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <p className="mt-2 text-[11px] font-medium text-slate-600">Used during Stage 2 to correct clinical terminology and structure after speech-to-text, without adding new facts.</p>
                  </div>
                  ...
                  <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                    <div className="mb-2 flex items-center justify-between">
                      <span className="font-semibold text-slate-800">
                        Clinical Synthesis Instructions & Clinical Disclaimer
                      </span>
                      <button
                        type="button"
                        onClick={() =>
        ...
        <div className="flex items-center justify-between border-t border-slate-100 bg-slate-50/50 px-6 py-3">
          <span className="text-[10px] text-slate-500">Read-only workflow inspection</span>
          <button
            type="button"
            onClick={onClose}
