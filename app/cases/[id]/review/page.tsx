...
export default function CaseReviewPage() {
  ...
  const [activeReviewSection, setActiveReviewSection] = useState<"clinical" | "record" | "history" | "assets">("clinical");
