...
const DEFAULT_REDACTION_RULES = [
  ...
  { pattern: "\\b(?:insurance|card|policy)\\b\\s*(?:no\\.?|number|#)?\\s*[:=-]?\\s*[A-Z]{2,}[A-Z0-9-]{5,}\\b", flags: "gi", replacement: "[REDACTED_INSURANCE_IDENTIFIER]", description: "Redact insurance, policy, and membership card identifiers." },
